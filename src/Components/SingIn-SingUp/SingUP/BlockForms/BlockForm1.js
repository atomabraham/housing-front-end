  ...
  return (
    <>
      ...
      <div className="formSingUp1" id="formSingUp1">
        <p className="titlesForm titlesForm1" id="titlesForm1">
          AUTHENTIFICATION
        </p>
        <p
          className="titleDescriptionForm titleDescriptionForm1"
          id="titleDescriptionForm1"
        >
          VOS INFORMATIONS DE CONNEXION A VOTRE COMPTE
        </p>
        <div className="blockForm1" id="blockForm1">
          <div className="scrolldiv scrolldiv1" id="scrollDiv1">
            <p className="labelForm labelEmail" id="labelEmail">
              ADDRESSE EMAIL *
            </p>
            <input
              type="email"
              name="email"
              className="input inputEmail email"
              id="inputEmail"
              onChange={saveEmail}
            />
            <span className="error errorEmail" id="errorEmail"></span>
            <p className="labelForm labelUserName" id="labelUserName">
            ...
            <p className="labelForm labelPassword" id="labelPassword">
              MOT DE PASSE *
            </p>
            <input
              type="password"
              name="password"
              className="input inputPassword password"
              id="inputPassword"
            />
            <span className="error errorPassword" id="errorPassword"></span>
            <p
              className="labelForm labelPasswordRepeat"
              id="labelPasswordRepeat"
            >
              MOT DE PASSE *
            </p>
            <input
              ...
              className="input inputPasswordRepeat password_confirmation"
              id="password_confirmation"
            />
            <span
              className="error errorPasswordRepeat"
              id="errorPasswordRepeat"
            ></span>
          </div>
          <div className="blockButton" id="blockButton">
            <button
              type="button"
              disabled="true"
              className="prevButton prevButton1"
              id="prevButton prevButton1"
            >
              PRECEDENT
            </button>
            <button
              type="button"
              onClick={Form1Next}
              className="nextButton nextButton1"
              id="nextButton nextButton1"
            >
              SUIVANT
            </button>
          </div>
