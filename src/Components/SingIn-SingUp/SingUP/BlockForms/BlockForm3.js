  ...
  return (
    <>
      <div className="formSingUp3" id="formSingUp3">
        <p className="titlesForm titlesForm3" id="titlesForm3">
          ADDRESSE
        </p>
        <p
        ...
        <div className="blockForm1 " id="blockForm1">
          <div className="scrolldiv2 blockForm3" id="scrollDiv2">
            <p className="labelForm labelCountry" id="labelCountry">
              PAYS *
            </p>
            <input
              type="text"
              ...
              id="inputName"
            />
            <p className="labelForm labelCity" id="labelCity">
              VILLE *
            </p>
            <input
              type="text"
              ...
              id="inputUserName"
            />
            <p className="labelForm labelPostalCode" id="labelPostalCode">
              CODE POSTAL (facultatif)
            </p>
            <input
              type="phone"
              name="postalcode"
              className="input inputNumberPhone"
              id="inputPassword"
            />
          </div>
          <div className="blockButton3" id="blockButton3">
            <button
              type="button"
              onClick={Form3Prev}
              className="prevButton prevButton3"
              id="prevButton3"
            >
              PRECEDENT
            </button>
            <button
              type="button"
              onClick={Form3Next}
              className="nextButton nextButton3"
              id="nextButton3"
            >
              SUIVANT
            </button>
