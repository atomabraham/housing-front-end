		...
		(async () => {
			try {
				...
				if (resp.status === 200 && resp.data.data.role==="User") {
                    let myAccount=document.getElementById('linkMenu1')
                    let myFavoris=document.getElementById('linkMenu2')
                    let myProperty=document.getElementById('linkMenu3')
                    let contactUs=document.getElementById('linkMenu4')
                    let login=document.getElementById('linkMenu5')
                    let logout=document.getElementById('linkMenu6')
                    ...
                    let login=document.getElementById('linkMenu5')
                    let logout=document.getElementById('linkMenu6')
                    let admin=document.getElementById('linkMenu33')
    ...
    <nav className='firstBanner' id='FirstBanner'>
        <div className='blockLogo' id='blockLogo'>
            ...
            <Link to="/CreatePost" className='postProperty' id='postProperty'>
                <svg className='iconAddPost' id='iconAddPost' xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-plus-circle" viewBox="0 0 16 16">
                    ...
                    <span className='contentMenu'>
                        ...
                        <ul className='listLinks' id='listLinks'>
                            <li className='linkMenu0'>
                                <a className='linkMenu linkMenu0' id='linkMenu0' href='#'>Acheter</a>
                            </li>
                            <li className='linkMenu01'>
                                <a className='linkMenu linkMenu01' id='linkMenu01' href='#'>Louer</a>
                            </li>
                            <li className='linkMenu2'>
                                <a className='linkMenu linkMenu2' id='linkMenu2' href='#'>Mes favoris</a>
                            </li>
                            <li className='linkMenu3'>
                                <a className='linkMenu linkMenu3' id='linkMenu3' href='#'>Mes biens</a>
                            </li>
                            <li className='linkMenu33'>
                                <a className='linkMenu linkMenu33' id='linkMenu33' href='#'>ADMINISTRATEUR</a>
                            </li>
                            <li className='linkMenu1'>
                                <a className='linkMenu linkMenu1' id='linkMenu1' href='#'>Mon Compte</a>
                            </li>
                            <li className='linkMenu4'>
                                <a className='linkMenu linkMenu4' id='linkMenu4'href='#login'>Nous contacter</a>
                            </li>
                            <li className='linkMenu5'>
                                <a className='linkMenu linkMenu5' id='linkMenu5' onClick={() => { handleShow(); menu();}} href='#login'>Se connecter</a>
                            </li>
                            <li className='linkMenu6'>
                                <a onClick={handleLogout} className='linkMenu linkMenu6' id='linkMenu6' href='#'>Se déconnecter</a>
                            </li>
                        </ul>
                    </span>
                </li>
