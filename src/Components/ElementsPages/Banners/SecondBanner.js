...
function SecondBanner(){
    ...
    //     let inputWordKey = document.getElementById('inputWordKey')
    ...
    //     formData.append('world', inputWordKey.value)
        ...
        <nav className='secondBanner' id='secondBanner' >
            {/* <React.Fragment className='filterSelect'> */}
                <div className='blockFilter' id='blockFilter'>
                    <form>
                        <input type='text' className='inputFilter inputLouer' id='inputWordKey' value={world} onChange={handleChangeWorld} placeholder='Mots clés'/>

                        <input type='text' className='inputFilter inputCity' id='inputCity' value={city} onChange={handleChangeCity} placeholder='ville'/>

                        <input type='text' className='inputFilter inputType' id='inputType' value={type} onChange={handleChangeType} placeholder='Type'/>

                        <input type='text' className='inputFilter inputStatus' id='inputStatus' value={status} onChange={handleChangeStatus} placeholder='A Louer'/>

                        <button type='button'className='submitSearch' id='submitSearch'>
                            <Link to={`/search?world=${world}&status=${status}&type=${type}&city=${city}`}>
