...
// import LayoutOptionController from "../../Controllers/DahboardAdmin/AgrementController";
    ...
    <>
      ...
      <Row className="blockProfile">
        <Row className="blockProfile2">
          ...
          <Row className="lineblockProfile"></Row>
          {/* menus */}
          {/* Statistics */}
          <Row
            disabled
            className="rowMenuDashboard"
            id="rowMenuStatistic"
            onClick={LayoutStatisticController}
          >
            <Col sm="1">
              <AutoGraph
                className="iconLeftNavBarAdmin"
                fontSize="large"
                color="#f6b100"
              />
            </Col>
            <Col sm="10">
              <Link
                to="#/Statistics"
                className="linkDahboard linkStatistic"
                name="linkStatistic"
              >
                STATISQUES
              </Link>
          ...
          >
            ...
            <Col sm="10">
              <Link to="#/Properties" className="linkDahboard linkPropertiesD">
                PROPRIETES
              </Link>
            </Col>
          </Row>
          ...
          <Row className="rowMenuDashboard" id="rowMenuOption">
            ...
            <Col sm="10">
              <Link
                ...
                className="linkDahboard linkOptions"
              >
                OPTIONS
              </Link>
            </Col>
          ...
          >
            ...
            <Col sm="10">
              <Link to="#/Users" className="linkDahboard linkOptions">
                UTILISATEURS
              </Link>
            </Col>
          </Row>
          ...
          <Row
            disabled
            className="rowMenuDashboard"
            id="rowMenuTransaction"
            onClick={LayoutTransactionsController}
          >
            <Col sm="1">
              <Paid
                className="iconLeftNavBarAdmin"
            ...
            <Col sm="10">
              <Link to="#/Transactions" className="linkDahboard linkOptions">
                TRANSACTIONS
              </Link>
            </Col>
          </Row>
